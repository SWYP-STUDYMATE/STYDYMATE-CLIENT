...
export const API_CONFIG = {
  ...
  WORKERS_API: import.meta.env.VITE_WORKERS_API_URL || 'https://workers.languagemate.kr',
...
export const API_ENDPOINTS = {
  ...
  ONBOARDING: {
    ...
    STEP: (stepNumber) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboarding/steps/${stepNumber}/save`,
    CURRENT: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboarding/steps/current`,
    SKIP: (stepNumber) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboarding/steps/${stepNumber}/skip`,
  ...
  ONBOARD: {
    LANGUAGE: {
      BASE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language`,
      LANGUAGES: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language/languages`,
      NATIVE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language/native-language`,
      LEVEL: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language/language-level`,
      LEVEL_TYPES_LANGUAGE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language/level-types-language`,
      LEVEL_TYPES_PARTNER: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/language/level-types-partner`
    },
    INTEREST: {
      BASE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest`,
      MOTIVATIONS: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/motivations`,
      TOPICS: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/topics`,
      LEARNING_STYLES: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/learning-styles`,
      LEARNING_EXPECTATIONS: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/learning-expectations`,
      MOTIVATION: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/motivation`,
      TOPIC: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/topic`,
      LEARNING_STYLE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/learning-style`,
      LEARNING_EXPECTATION: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/interest/learning-expectation`
    },
    PARTNER: {
      BASE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/partner`,
      PERSONALITY: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/partner/personality`,
      GROUP_SIZE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/partner/group-size`
    },
    SCHEDULE: {
      BASE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/schedule`,
      SCHEDULE: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/onboard/schedule/schedule`
    }
  },
  ...
  LEVEL_TEST: {
    ...
    COMPLETE: (testId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/level-test/${testId}/complete`,
    GET: (testId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/level-test/${testId}`,
    ...
    VOICE: {
      ...
      UPLOAD: (testId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/level-test/voice/${testId}/upload`,
      ANALYZE: (testId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/level-test/voice/${testId}/analyze`,
      RESULT: (testId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/level-test/voice/${testId}/result`
    }
  },
  ...
  WORKERS: {
    ...
    WEBRTC: {
      ...
      LEAVE_ROOM: (roomId) => `${API_CONFIG.WORKERS_API}/webrtc/${roomId}/leave`,
      GET_ROOM_INFO: (roomId) => `${API_CONFIG.WORKERS_API}/webrtc/${roomId}/info`,
      GET_ICE_SERVERS: (roomId) => `${API_CONFIG.WORKERS_API}/webrtc/${roomId}/ice-servers`,
      WEBSOCKET: (roomId, userId, userName) => 
        `${API_CONFIG.WORKERS_API.replace('https', 'wss')}/webrtc/${roomId}/ws?userId=${userId}&userName=${encodeURIComponent(userName)}`
    }
  },
  ...
  MATCHING: {
    ...
    ACCEPT: (matchId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/matching/accept/${matchId}`,
    REJECT: (matchId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/matching/reject/${matchId}`,
  ...
  CHAT: {
    ...
    MESSAGES: (roomId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/chat/rooms/${roomId}/messages`,
    SEND: `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/chat/send`,
    LEAVE: (roomId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/chat/rooms/${roomId}/leave`,
  ...
  SESSION: {
    ...
    JOIN: (sessionId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/sessions/${sessionId}/join`,
    LEAVE: (sessionId) => `${API_CONFIG.MAIN_SERVER}${API_CONFIG.API_VERSION}/sessions/${sessionId}/leave`,
