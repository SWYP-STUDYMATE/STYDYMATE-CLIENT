                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-[20px] p-6 border border-[#E7E7E7]">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                    <Video className={`w-6 h-6 mx-auto mb-2 ${sessionData.type === 'video' ? 'text-[#00C471]' : 'text-[#929292]'
                                        }`} />
                                ...
                                >
                                    <Mic className={`w-6 h-6 mx-auto mb-2 ${sessionData.type === 'audio' ? 'text-[#00C471]' : 'text-[#929292]'
                                        }`} />
                        ...
                        <div className="bg-white rounded-[20px] p-6 border border-[#E7E7E7]">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                    <User className={`w-6 h-6 mx-auto mb-2 ${sessionData.participantType === 'individual' ? 'text-[#00C471]' : 'text-[#929292]'
                                        }`} />
                                ...
                                >
                                    <Users className={`w-6 h-6 mx-auto mb-2 ${sessionData.participantType === 'group' ? 'text-[#00C471]' : 'text-[#929292]'
                                        }`} />
                        ...
                        <div className="bg-white rounded-[20px] p-6 border border-[#E7E7E7]">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <button
                                    ...
                                    className={`w-12 h-6 rounded-full transition-colors ${sessionData.isRecurring ? 'bg-[#00C471]' : 'bg-[#E7E7E7]'
                                        } relative`}
                                >
